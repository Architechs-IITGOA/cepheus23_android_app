    ...
    fun SetEvents():List<EventData>{
        ...
        Eventlist.add(
            EventData(
                ...
                "9:00 PM (48 hrs)",
                "Loren Ipsum",
                "Dessign a Multiverse themed website in 24 hours",
                "Utsav Bansal",
                "6267184086",
        ...
        Eventlist.add(
            EventData(
                ...
                "6:00 PM (1 hrs)",
                "Circuital Dilemma",
                "Two staged comeptition to unveil your digital circuit problem solving skills",
                "Atharva Bhawsar",
                "9643204258",
        ...
        Eventlist.add(
            EventData(
                ...
                "Buil an ML model to save the planet in Cepheus verse",
                "Ananya Alekar",
                "8424942069",
